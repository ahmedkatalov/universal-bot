...
var bankMarkers = map[string]*regexp.Regexp{
	...
	"ВТБ":            regexp.MustCompile(`(?i)втб|vtb`),
	"Т-Банк":         regexp.MustCompile(`(?i)тинькофф|т.?банк|тбанк|tinkoff|t.?bank`),
	"Озон Банк":      regexp.MustCompile(`(?i)озон\s*банк|ozon\s*bank|озон`),
	"Россельхозбанк": regexp.MustCompile(`(?i)россельхоз|рсхб|rshb`),
	"Газпромбанк":    regexp.MustCompile(`(?i)газпромбанк|гпб|gazprombank`),
	...
	"МКБ":            regexp.MustCompile(`(?i)московский\s*кредитн|мкб(\W|$)`),
	"Росбанк":        regexp.MustCompile(`(?i)росбанк|rosbank`),
	"ПСБ":            regexp.MustCompile(`(?i)промсвязьбанк|псб(\W|$)|psb`),
	"Уралсиб":        regexp.MustCompile(`(?i)уралсиб|uralsib`),
	"Ак Барс":        regexp.MustCompile(`(?i)ак\s*барс|ak\s*bars`),
	"Хоум Банк":      regexp.MustCompile(`(?i)хоум\s*(кредит|банк)|home\s*credit`),
	"Яндекс Банк":    regexp.MustCompile(`(?i)яндекс\s*(банк|пэй|pay)|yandex\s*bank`),
	...
	"Зенит":          regexp.MustCompile(`(?i)банк\s*зенит|zenit`),
	"Юникредит":      regexp.MustCompile(`(?i)юникредит|unicredit`),
	"Банк СПб":       regexp.MustCompile(`(?i)банк\s*санкт.?петербург|бспб`),
	...
	"Вайлдберриз":    regexp.MustCompile(`(?i)вайлдберриз|wildberries\s*банк|вб\s*банк`),
	"Хоум Кредит":    regexp.MustCompile(`(?i)хоум\s*кредит`),
	"Яндекс Пэй":     regexp.MustCompile(`(?i)яндекс\s*пэй`),
	"ДОМ.РФ":         regexp.MustCompile(`(?i)дом\.рф|дом\s*рф`),
	"РНКБ":           regexp.MustCompile(`(?i)рнкб|rncb`),
...
// "Газпромбанк" не определился как что-то другое по под-строке. Большая
// четвёрка (Сбер/Альфа/Т-Банк/ВТБ) — в самом конце: их короткие маркеры
// не должны перебивать составные названия других банков.
var bankOrder = []string{
	"Россельхозбанк", "Газпромбанк", "ПСБ", "Почта Банк", "МКБ",
	"Совкомбанк", "МТС Банк", "Росбанк", "Райффайзен", "Уралсиб", "Ак Барс",
	"Хоум Кредит", "Хоум Банк", "Яндекс Пэй", "Яндекс Банк", "ЮMoney", "ОТП Банк",
	"Ренессанс", "Зенит", "Юникредит", "Банк СПб", "Новиком", "Абсолют",
	"Локо-Банк", "Свой Банк", "Точка", "Модульбанк", "Кубань Кредит",
	"Металлинвест", "Драйв Клик", "Вайлдберриз", "ДОМ.РФ", "РНКБ", "Открытие",
