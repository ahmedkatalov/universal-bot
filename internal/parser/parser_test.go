...
func TestExtractAmount(t *testing.T) {
	cases := map[string]float64{
		...
		"просто текст":          0,
		"Умхадижиев Рахман 170т✅":     170000, // суффикс + эмодзи
		"Шошуков 22т.":                22000,  // суффикс + точка в конце
		"У Усумова Рауфа забрал 31 т": 31000,
	}
	...
	// «т.е.» — это НЕ «тысяч»: «22 т.е. потом» не должно стать 22000.
	if got := ExtractAmount("осталось 22 т.е. потом"); got == 22000 {
		t.Errorf("ExtractAmount(«22 т.е.») = 22000 — «т.е.» принято за тысячи")
	}
}
